...
export const PastThreadsList = ({ className = '' }: {className?: string;}) => {
  ...
  (allThreads[threadId1]?.lastModified ?? 0) > (allThreads[threadId2]?.lastModified ?? 0) ?
  -1 :
  1
  ).
  ...
  return (
    <div
      className={`void-flex void-flex-col void-mb-2 void-gap-2 void-w-full void-text-nowrap void-text-void-fg-3 void-select-none void-relative ${className}`}>
  ...
  return (
    <div
      ...
      onMouseLeave={() => setHoveredIdx(null)}>
          ...
          <LoaderCircle
            className="void-animate-spin void-bg-void-stroke-1 void-flex-shrink-0 void-flex-grow-0"
            size={14} /> :

          isRunning === 'awaiting_user' ?
          <MessageCircleQuestion
            className="void-bg-void-stroke-1 void-flex-shrink-0 void-flex-grow-0"
            size={14} /> :
