				...
				;((r.parse = F),
					...
					(r.diff = function (e, r) {
						...
						if (t.prerelease.length || n.prerelease.length) {
							for (var o in t)
								if (('major' === o || 'minor' === o || 'patch' === o) && t[o] !== n[o])
									return 'pre' + o
							return 'prerelease'
						}
						for (var o in t)
							if (('major' === o || 'minor' === o || 'patch' === o) && t[o] !== n[o]) return o
					}),
...
//# sourceURL=file:///Users/yashasnaidu/Kvantcode/void/src/vs/base/common/semver/semver.js