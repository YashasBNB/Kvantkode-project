...
import { GeneratorContext, haveContextForGenerator, runCachedGenerator } from './helpers'
...
export async function getScriptSuggestions(
	...
	try {
		...
		const commandToRun = script && typeof script === 'function' ? script(tokenArray) : script
