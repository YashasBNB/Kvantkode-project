...
class TypeScriptFormattingProvider
	implements vscode.DocumentRangeFormattingEditProvider, vscode.OnTypeFormattingEditProvider
{
	public constructor(
...
export function register(
	...
	return conditionalRegistration([requireGlobalConfiguration(language.id, 'format.enable')], () => {
