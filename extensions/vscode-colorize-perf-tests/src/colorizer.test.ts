...
suite('Tokenization Performance', () => {
	...
	suiteSetup(async function () {
		...
		await workspace
			...
			.update('experimental.preferTreeSitter', ['typescript'], ConfigurationTarget.Global)
	})
	suiteTeardown(async function () {
		await workspace
			.getConfiguration('editor')
			.update('experimental.preferTreeSitter', originalSettingValue, ConfigurationTarget.Global)
	})
