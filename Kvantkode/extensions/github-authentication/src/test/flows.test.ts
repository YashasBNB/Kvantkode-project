	...
	const testCases: Array<{ label: string; query: IFlowQuery; expectedFlows: Flows[] }> = [
		{
			...
			expectedFlows: [Flows.UrlHandlerFlow, Flows.LocalServerFlow, Flows.DeviceCodeFlow],
		},
		{
		...
		},
		{
			...
			expectedFlows: [Flows.UrlHandlerFlow, Flows.DeviceCodeFlow, Flows.PatFlow],
		},
		{
		...
		},
		{
			...
			expectedFlows: [Flows.LocalServerFlow, Flows.DeviceCodeFlow, Flows.PatFlow],
		},
		{
