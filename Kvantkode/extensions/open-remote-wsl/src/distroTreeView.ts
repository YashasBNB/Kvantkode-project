...
export class DistroTreeDataProvider
	extends Disposable
	implements vscode.TreeDataProvider<DataTreeItem>
{
	...
	constructor(
		...
		this._register(
			vscode.commands.registerCommand('openremotewsl.explorer.addDistro', () =>
				promptInstallNewWSLDistro(wslManager),
			),
		)
		this._register(
			vscode.commands.registerCommand('openremotewsl.explorer.refresh', () => this.refresh()),
		)
		this._register(
			vscode.commands.registerCommand('openremotewsl.explorer.emptyWindowInNewWindow', (e) =>
				this.openRemoteWSLWindow(e, false),
			),
		)
		this._register(
			vscode.commands.registerCommand('openremotewsl.explorer.emptyWindowInCurrentWindow', (e) =>
				this.openRemoteWSLWindow(e, true),
			),
		)
		this._register(
			vscode.commands.registerCommand('openremotewsl.explorer.reopenFolderInNewWindow', (e) =>
				this.openRemoteWSLocationWindow(e, false),
			),
		)
		this._register(
			vscode.commands.registerCommand('openremotewsl.explorer.reopenFolderInCurrentWindow', (e) =>
				this.openRemoteWSLocationWindow(e, true),
			),
		)
		this._register(
			vscode.commands.registerCommand('openremotewsl.explorer.deleteFolderHistoryItem', (e) =>
				this.deleteDistroLocation(e),
			),
		)
		this._register(
			vscode.commands.registerCommand('openremotewsl.explorer.setDefaultDistro', (e) =>
				this.setDefaultDistro(e),
			),
		)
		this._register(
			vscode.commands.registerCommand('openremotewsl.explorer.deleteDistro', (e) =>
				this.deleteDistro(e),
			),
		)
	}
			...
			return distros.map(
				(distro) =>
					new DistroItem(
						distro.name,
						distro.isDefault,
						this.locationHistory.getHistory(distro.name),
					),
			)
		}
