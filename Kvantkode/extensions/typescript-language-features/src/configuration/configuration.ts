...
export class ImplicitProjectConfiguration {
	...
	constructor(configuration: vscode.WorkspaceConfiguration) {
		...
		this.strictFunctionTypes =
			ImplicitProjectConfiguration.readImplicitStrictFunctionTypes(configuration)
	}
	...
	private static readExperimentalDecorators(configuration: vscode.WorkspaceConfiguration): boolean {
		return (
			configuration.get<boolean>('js/ts.implicitProjectConfig.experimentalDecorators') ??
...
export abstract class BaseServiceConfigurationProvider implements ServiceConfigurationProvider {
	public loadFromWorkspace(): TypeScriptServiceConfiguration {
		...
		return {
			...
			webProjectWideIntellisenseSuppressSemanticErrors:
				this.readWebProjectWideIntellisenseSuppressSemanticErrors(configuration),
	...
	private readWatchOptions(
		...
		const watchOptions = configuration.get<Proto.WatchOptions | vscodeWatcherName>(
			'typescript.tsserver.watchOptions',
		)
