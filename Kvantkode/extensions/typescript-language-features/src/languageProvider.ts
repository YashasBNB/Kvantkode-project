	...
	private async registerProviders(): Promise<void> {
		...
		await Promise.all([
			...
			import('./languageFeatures/codeLens/implementationsCodeLens').then((provider) =>
				this._register(
					provider.register(selector, this.description, this.client, cachedNavTreeResponse),
				),
			),
			import('./languageFeatures/codeLens/referencesCodeLens').then((provider) =>
				this._register(
					provider.register(selector, this.description, this.client, cachedNavTreeResponse),
				),
			),
			...
			import('./languageFeatures/copyPaste').then((provider) =>
				this._register(
					provider.register(selector, this.description, this.client, this.fileConfigurationManager),
				),
			),
			import('./languageFeatures/definitions').then((provider) =>
				this._register(provider.register(selector, this.client)),
			),
			import('./languageFeatures/directiveCommentCompletions').then((provider) =>
				this._register(provider.register(selector, this.client)),
			),
			...
			import('./languageFeatures/documentSymbol').then((provider) =>
				this._register(provider.register(selector, this.client, cachedNavTreeResponse)),
			),
			...
			import('./languageFeatures/hover').then((provider) =>
				this._register(provider.register(selector, this.client, this.fileConfigurationManager)),
			),
			...
			import('./languageFeatures/tagClosing').then((provider) =>
				this._register(provider.register(selector, this.description, this.client)),
			),
