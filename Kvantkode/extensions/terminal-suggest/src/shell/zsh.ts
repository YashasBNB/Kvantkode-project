...
const commandDescriptionsCache:
	| Map<string, { shortDescription?: string; description: string; args: string | undefined }>
...
export async function getZshGlobals(
	...
	return [...(await getAliases(options)), ...(await getBuiltins(options, existingCommands))]
}
...
export function getCommandDescription(
	command: string,
): { documentation?: string; description?: string; args?: string | undefined } | undefined {
