...
type Tab = 'models' | 'localProviders' | 'providers' | 'featureOptions' | 'mcp' | 'general' | 'all';
...
const SimpleModelSettingsDialog = ({
  ...
  const onSave = async () => {
    ...
    for (const k of modelOverrideKeys) {
      ...
      const isEmpty =
      parsedInput[k] === '' || parsedInput[k] === null || parsedInput[k] === undefined;
      if (!isEmpty) {
      ...
      mouseDownInsideModal.current = false;
        ...
        onMouseDown={(e) => {
          ...
          e.stopPropagation();
				...
				<div className="void-flex void-justify-between void-items-center void-mb-4">
					...
					<button onClick={onClose} className="void-text-void-fg-3 hover:void-text-void-fg-1">
				...
				<div className="void-text-sm void-text-void-fg-3 void-mb-4">
					{type === 'default' ?
          `${modelName} comes packaged with KvantKode, so you shouldn't need to change these settings.` :
          isUnrecognizedModel ?
          `Model not recognized by KvantKode.` :
          `KvantKode recognizes ${modelName} ("${recognizedModelName}").`}
				</div>
        ...
        <div className="void-text-sm void-text-void-fg-3 void-mb-4">
          ...
          readOnly={!overrideEnabled} />
				...
				{errorMsg && <div className="void-text-red-500 void-mt-2 void-text-sm">{errorMsg}</div>}
				...
				<div className="void-flex void-justify-end void-gap-2 void-mt-4">
					...
					<VoidButtonBgDarken onClick={onSave} className="void-px-3 void-py-1 void-bg-[#0e70c0] void-text-white">
						Save
					</VoidButtonBgDarken>
				</div>
			</div>
...
export const ModelDump = ({ filteredProviders }: {filteredProviders?: ProviderName[];}) => {
  ...
  return (
    <div className="">
        ...
        <Asterisk
          size={14}
          className="void-inline-block void-align-text-top void-brightness-115 void-stroke-[2] void-text-[#0e70c0]"
      ...
      <div className="void-mt-4">
          ...
          text="Added"
          className="void-bg-[#0e70c0] void-text-white void-px-3 void-py-1 void-rounded-sm" />
      ...
      <div className="void-mt-4">
            ...
            className="void-text-void-fg-4">
					...
					{errorString &&
        <div className="void-text-red-500 void-truncate void-whitespace-nowrap void-mt-1">{errorString}</div>
        }
				</div> :
  ...
  return (
    <ErrorBoundary>
          ...
          compact={true} />
				...
				{!subTextMd ? null : <div className="void-py-1 void-px-3 void-opacity-50 void-text-sm">{subTextMd}</div>}
			</div>
		</ErrorBoundary>);
...
export const VoidProviderSettings = ({ providerNames }: {providerNames: ProviderName[];}) => {
  const names = providerNames.filter((p) => p !== 'openAICompatible');
  return (
    <>
...
export const OllamaSetupInstructions = ({ sayWeAutoDetect }: {sayWeAutoDetect?: boolean;}) => {
  return (
    <div className="prose-p:void-my-0 prose-ol:void-list-decimal prose-p:void-py-0 prose-ol:void-my-0 prose-ol:void-py-0 prose-span:void-my-0 prose-span:void-py-0 void-text-void-fg-3 void-text-sm void-list-decimal void-select-text">
			<div className="">
				<ChatMarkdownRender string={`Ollama Setup Instructions`} chatMessageLocation={undefined} />
			</div>
          ...
          chatMessageLocation={undefined} />
			...
			<div className=" void-pl-6">
				<ChatMarkdownRender string={`2. Open your terminal.`} chatMessageLocation={undefined} />
			</div>
			<div className="void-pl-6 void-flex void-items-center void-w-fit" data-tooltip-id="void-tooltip-ollama-settings">
				<ChatMarkdownRender
      ...
      <div className=" void-pl-6">
					<ChatMarkdownRender
          string={`KvantKode automatically detects locally running models and enables them.`}
          chatMessageLocation={undefined} />
...
export const OneClickSwitchButton = ({
  ...
  return (
    <>
        ...
        <AnimatedCheckmarkButton text="Settings Transferred" className="void-bg-none" /> :
        null}
			</VoidButtonBgDarken>
...
const MCPServersList = () => {
  ...
  if (mcpServiceState.error) {
    content = <div className="void-text-void-fg-3 void-text-sm void-mt-2">{mcpServiceState.error}</div>;
  } else {
    const entries = Object.entries(mcpServiceState.mcpServerOfName);
    if (entries.length === 0) {
      content = <div className="void-text-void-fg-3 void-text-sm void-mt-2">No servers found</div>;
    } else {
...
export const Settings = () => {
  ...
  const shouldShowTab = (tab: Tab) => {
    // Hide Models and provider tabs entirely, even in 'All Settings'
    if (tab === 'models' || tab === 'localProviders' || tab === 'providers') return false;
    return selectedSection === 'all' || selectedSection === tab;
  };
  const accessor = useAccessor();
              ...
              selectedSection === tab ? "void-bg-[#0e70c0]/80 void-text-white void-font-medium void-shadow-sm" : "void-bg-void-bg-2 hover:void-bg-void-bg-2/80 void-text-void-fg-1"} `}>
				...
				<main className="void-flex-1 void-p-6 void-select-none">
					<div className="void-max-w-3xl">
						<h1 className="void-text-2xl void-w-full">{`KvantKode's Settings`}</h1>
                    ...
                    {`KvantKode can access any model that you host locally. We automatically detect your local models by default.`}</h3>
							...
							<div className={shouldShowTab('providers') ? `` : "void-hidden"}>
								<ErrorBoundary>
									...
									<h3
                    className={`void-text-void-fg-3 void-mb-2`}>
                    {`KvantKode can access models from Anthropic, OpenAI, OpenRouter, and more.`}</h3>
                            ...
                            data-tooltip-class-name="void-max-w-[20px]">
                                ...
                                'Disabled'}
													...
													<ErrorBoundary>
														<div
                              className={`void-my-2 ${!settingsState.globalSettings.enableAutocomplete ? "void-hidden" : ""}`}>
                              ...
                              'Different model'}
													...
													{/* Model Dropdown */}
													<div
                            className={`void-my-2 ${settingsState.globalSettings.syncApplyToChat ? "void-hidden" : ""}`}>
                            ...
                            return (
                              <div key={approvalType} className="void-flex void-items-center void-gap-x-2 void-my-2">
                              ...
                              voidSettingsService.setGlobalSetting(
                                ...
                                newVal
														...
														<span className="void-text-void-fg-3 void-text-xs void-pointer-events-none">
															{settingsState.globalSettings.includeToolLintErrors ?
                              'Fix lint errors' :
                              `Fix lint errors`}
														</span>
													</div>
                              ...
                              voidSettingsService.setGlobalSetting('autoAcceptLLMChanges', newVal)
										...
										<div className="void-w-full">
											...
											<div className="void-text-sm void-text-void-fg-3 void-mt-1">{`Settings that control the visibility of KvantKode suggestions in the code editor.`}</div>
                              ...
                              voidSettingsService.setGlobalSetting(
                                ...
                                newVal
														...
														<span className="void-text-void-fg-3 void-text-xs void-pointer-events-none">
															{settingsState.globalSettings.showInlineSuggestions ?
                              ...
                              'Different model'}
													...
													{/* Model Dropdown */}
													<div
                            className={`void-my-2 ${settingsState.globalSettings.syncSCMToChat ? "void-hidden" : ""}`}>
							...
							<div className={`${shouldShowTab('general') ? `` : "void-hidden"} void-flex void-flex-col void-gap-12`}>
								...
								<div>
									<ErrorBoundary>
										...
										<h4 className="void-text-void-fg-3 void-mb-4">{`Transfer your editor settings into KvantKode.`}</h4>
								...
								<div>
									...
									<h4 className="void-text-void-fg-3 void-mb-4">{`Transfer KvantKode's settings and chats in and out of KvantKode.`}</h4>
                    ...
                    {`IDE settings, keyboard settings, and theme customization.`}</h4>
                          ...
                          nativeHostService.showItemInFolder(environmentService.logsHome.fsPath);
								...
								<div className="void-max-w-[600px]">
									...
									<h4 className={`void-text-void-fg-3 void-mb-4`}>
										Very basic anonymous usage tracking helps us keep KvantKode running smoothly.
										You may opt out below. Regardless of this setting, KvantKode never sees your
                      ...
                      string={`
						...
						Alternatively, place a \`.kvantkoderules\` file in the root of your workspace.
								`}
                      chatMessageLocation={undefined} />
                          ...
                          onChange={(newValue) => {
                            voidSettingsService.setGlobalSetting('disableSystemMessage', newValue);
										...
										<div className="void-text-void-fg-3 void-text-xs void-mt-1">
											{`When disabled, KvantKode will not include anything in the system message except for content you specified above.`}
										</div>
									</div>
								</div>
							</div>
