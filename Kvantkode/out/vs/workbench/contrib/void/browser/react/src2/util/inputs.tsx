...
import {
  ...
  ExtractedSearchReplaceBlock } from
...
export const WidgetComponent = <CtorParams extends any[], Instance>({
  ...
  return (
    <div ref={containerRef} className={className === undefined ? `void-w-full` : className}>
			{children}
		</div>);
...
export const VoidInputBox2 = forwardRef<HTMLTextAreaElement, InputBox2Props>(function X(
{
  initValue,
  placeholder,
  multiline,
  ...
  return (
    <>
      ...
      <div
        ...
        <div className="void-px-2 void-py-1 void-text-void-fg-1 void-bg-void-bg-2-alt void-border-b void-border-void-border-3 void-sticky void-top-0 void-bg-void-bg-1 void-z-10 void-select-none void-pointer-events-none">
							{optionText ?
              ...
              return (
                ...
                <div
                  ...
                  <span className="void-opacity-60 void-text-sm">{o.fullName}</span>
											...
											{o.nextOptions || o.generateNextOptions ? <ChevronRight size={12} /> : null}
										</div>);
    ...
    <WidgetComponent
      ...
      onCreateInstance={useCallback(
        (instance: InputBox) => {
          ...
          disposables.push(instance.onDidChange((newText) => onChangeText(newText)));
          if (onCreateInstance) {
...
const SingleDiffEditor = ({
  ...
  return <div className="void-w-full void-bg-void-bg-3 bg-editor-style-override" ref={divRef} />;
};
