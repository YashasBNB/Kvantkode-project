...
const FadeIn = ({
  ...
  return (
    <div
      className={className}
      style={{ opacity, transition: `opacity ${effectiveDurationMs}ms ease-in-out` }}
      {...props}>
...
const providerNamesOfTab: Record<TabName, ProviderName[]> = {
  ...
  Paid: providerNames.filter(
    (pn) =>
    !(['gemini', 'openRouter', ...localProviderNames, ...cloudProviders] as string[]).includes(
      pn
    )
  ) as ProviderName[],
  ...
  return (
    <div className="void-flex void-flex-col md:void-flex-row void-w-full void-h-[80vh] void-gap-6 void-max-w-[900px] void-mx-auto void-relative">
          ...
          <button
            ...
            currentTab === tab ? "void-bg-[#0e70c0]/80 void-text-white void-font-medium void-shadow-sm" : "void-bg-void-bg-2 hover:void-bg-void-bg-2/80 void-text-void-fg-1"} void-transition-all void-duration-200`}
...
const OnboardingPageShell = ({
  ...
  return (
    <div
      className={`void-h-[80vh] void-text-lg void-flex void-flex-col void-gap-4 void-w-full void-mx-auto ${hasMaxWidth ? "void-max-w-[600px]" : ""} ${className}`}>
...
const VoidOnboardingContent = () => {
  ...
  voidSettingsState.settingsOfProvider[selectedProviderName]._didFillInProviderSettings;
  const isApiKeyLongEnoughIfApiKeyExists =
  selectedProviderName && voidSettingsState.settingsOfProvider[selectedProviderName].apiKey ?
  voidSettingsState.settingsOfProvider[selectedProviderName].apiKey.length > 15 :
  true;
  const isAtLeastOneModel =
  selectedProviderName &&
  voidSettingsState.settingsOfProvider[selectedProviderName].models.length >= 1;
  ...
  const detailedDescOfWantToUseOption: { [wantToUseOption in WantToUseOption]: string } = {
    ...
    private:
    'Private-hosted so your data never leaves your computer or network. [Email us](mailto:founders@kvantkode.com) for help setting up at your company.',
    cheap:
  ...
  const contentOfIdx: {[pageIndex: number]: React.ReactNode;} = {
    ...
    <OnboardingPageShell
      ...
      <div className="void-flex void-flex-col void-items-center void-gap-8">
						<div className="void-text-5xl void-font-light void-text-center">Welcome to KvantKode</div>
    ...
    <OnboardingPageShell
      hasMaxWidth={false}
      content={<AddProvidersPage pageIndex={pageIndex} setPageIndex={setPageIndex} />} />,
