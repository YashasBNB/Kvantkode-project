...
const VoidSelectionHelper = ({ rerenderKey }: VoidSelectionHelperProps) => {
  ...
  return (
    <div
      className=" void-pointer-events-auto void-select-none void-z-[1000] void-rounded-sm void-shadow-md void-flex void-flex-nowrap void-text-nowrap void-border void-border-void-border-3 void-bg-void-bg-2 void-transition-all void-duration-200 ">
