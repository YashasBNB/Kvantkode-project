    ...
    <div className={`void-rounded-lg void-border void-border-red-200 void-bg-red-50 void-p-4 void-overflow-auto`}>
          ...
          <button
            ...
            onClick={() => setIsExpanded(!isExpanded)}>
							...
							{isExpanded ? <ChevronUp className="void-h-5 void-w-5" /> : <ChevronDown className="void-h-5 void-w-5" />}
						</button>
          }
					{showDismiss && onDismiss &&
          <button className="void-text-red-600 hover:void-text-red-800 void-p-1 void-rounded" onClick={onDismiss}>
