...
export class DiffEditorItemTemplate extends Disposable implements IPooledObject<TemplateData> {
	private readonly _viewModel = observableValue<DocumentDiffItemViewModel | undefined>(
		this,
		undefined,
	)
	...
	private readonly isModifedFocused = observableCodeEditor(this.editor.getModifiedEditor())
		.isFocused
	private readonly isOriginalFocused = observableCodeEditor(this.editor.getOriginalEditor())
		.isFocused
