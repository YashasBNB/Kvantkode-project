...
export class InlineCompletionsSource extends Disposable {
	...
	public readonly inlineCompletions = this._register(
		disposableObservableValue<UpToDateInlineCompletions | undefined>(
			'inlineCompletions',
			undefined,
		),
	)
	public readonly suggestWidgetInlineCompletions = this._register(
		disposableObservableValue<UpToDateInlineCompletions | undefined>(
			...
			try {
				...
				if (
					...
					(activeInlineCompletion.canBeReused(this._textModel, position) ||
						...
						) /* Inline Edit wins over completions if it's already been shown*/ ||
...
export class InlineCompletionWithUpdatedRange extends Disposable {
	...
	public get updatedEdit(): IObservable<OffsetEdit | undefined> {
		return this._updatedEditObj.offsetEdit
	}
	public get updatedEditModelVersion() {
	...
	public get sourceInlineCompletion() {
		return this.inlineCompletion.sourceInlineCompletion
	}
	public get isInlineEdit() {
	...
	constructor(
		...
		private readonly _textModel: ITextModel,
		private readonly _modelVersion: IObservableWithChange<
			number | null,
			IModelContentChangedEvent | undefined
		>,
		public readonly request: UpdateRequest,
...
class UpdatedEdit extends Disposable {
	...
	public get offsetEdit(): IObservable<OffsetEdit | undefined> {
		...
		this._innerEdits = offsetEdit.edits.map((edit) => {
			if (isInlineEdit) {
				const replacedRange = Range.fromPositions(
					...
					this._textModel.getPositionAt(edit.replaceRange.endExclusive),
				)
	...
	private _applyTextModelChanges(
		textModelChanges: OffsetEdit,
		edits: SingleUpdatedEdit[],
	): SingleUpdatedEdit[] {
...
abstract class SingleUpdatedEdit {
	...
	constructor(edit: SingleOffsetEdit) {
		this._edit = edit
	}
	...
	protected abstract applyChanges(
		...
		textModelChanges: OffsetEdit,
	): { edit: SingleOffsetEdit; editHasChanged: boolean } | undefined
}
...
class SingleUpdatedCompletion extends SingleUpdatedEdit {
	...
	protected applyChanges(
		edit: SingleOffsetEdit,
		textModelChanges: OffsetEdit,
	): { edit: SingleOffsetEdit; editHasChanged: boolean } {
...
class SingleUpdatedNextEdit extends SingleUpdatedEdit {
	...
	constructor(edit: SingleOffsetEdit, replacedText: string) {
		super(edit)
