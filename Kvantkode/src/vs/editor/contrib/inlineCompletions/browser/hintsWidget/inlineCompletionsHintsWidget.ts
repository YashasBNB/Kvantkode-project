...
export class InlineSuggestionHintsContentWidget extends Disposable implements IContentWidget {
	...
	private readonly _warningMessageNode = n
		.div(
			{
	...
	private readonly previousAction = this._register(
	...
	private readonly availableSuggestionCountAction = this._register(
		new Action('inlineSuggestionHints.availableSuggestionCount', '', undefined, false),
	)
	private readonly nextAction = this._register(
		this.createCommandAction(
			showNextInlineSuggestionActionId,
			localize('next', 'Next'),
	...
	private readonly clearAvailableSuggestionCountLabelDebounced = this._register(
