...
export class BackupMainService implements IBackupMainService {
	...
	registerWorkspaceBackup(
		...
		if (
			!this.workspaces.some((workspace) => workspaceInfo.workspace.id === workspace.workspace.id)
		) {
	...
	private hasBackups(
		backupLocation: IWorkspaceBackupInfo | IEmptyWindowBackupInfo | IFolderBackupInfo,
	): Promise<boolean> {
