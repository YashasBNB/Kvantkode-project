...
export class WorkspaceEdit implements vscode.WorkspaceEdit {
	...
	set(
		uri: URI,
		edits: ReadonlyArray<[NotebookEdit, vscode.WorkspaceEditEntryMetadata | undefined]>,
	): void
...
export class CustomExecution implements vscode.CustomExecution {
	...
	constructor(
		callback: (resolvedDefinition: vscode.TaskDefinition) => Thenable<vscode.Pseudoterminal>,
	) {
...
export class ChatResponseReferencePart {
	...
	constructor(
		...
		iconPath?: vscode.Uri | vscode.ThemeIcon | { light: vscode.Uri; dark: vscode.Uri },
		options?: {
			status?: { description: string; kind: vscode.ChatResponseReferencePartStatusKind }
		},
	) {
		this.value = value
...
export class LanguageModelChatMessage implements vscode.LanguageModelChatMessage {
	...
	set content2(
		value: (string | LanguageModelToolResultPart | LanguageModelToolCallPart)[] | undefined,
	) {
		if (value) {
...
export class LanguageModelChatMessage2 implements vscode.LanguageModelChatMessage2 {
	...
	set content2(
		value:
			| (string | LanguageModelToolResultPart | LanguageModelToolCallPart | LanguageModelDataPart)[]
			| undefined,
	) {
		if (value) {
			this.content = value.map((part) => {
