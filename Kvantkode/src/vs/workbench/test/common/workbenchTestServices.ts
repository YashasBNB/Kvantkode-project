...
export class TestContextService implements IWorkspaceContextService {
	...
	isCurrentWorkspace(
		...
		return (
			URI.isUri(workspaceIdOrFolder) && isEqual(this.workspace.folders[0].uri, workspaceIdOrFolder)
		)
	}
}
...
export function createFileStat(
	...
	isFile?: boolean,
	isDirectory?: boolean,
	children?: { resource: URI; isFile?: boolean; isDirectory?: boolean }[] | undefined,
