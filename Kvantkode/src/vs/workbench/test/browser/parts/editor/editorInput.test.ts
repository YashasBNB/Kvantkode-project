...
suite('EditorInput', () => {
	...
	test('Untyped inputs properly match UntitledTextEditorInput', () => {
		...
		const untitledTextEditorInput: UntitledTextEditorInput = instantiationService.createInstance(
	...
	test('Untyped inputs properly match DiffEditorInput', () => {
		...
		const diffEditorInput: DiffEditorInput = instantiationService.createInstance(
			DiffEditorInput,
			undefined,
			undefined,
			fileEditorInput1,
