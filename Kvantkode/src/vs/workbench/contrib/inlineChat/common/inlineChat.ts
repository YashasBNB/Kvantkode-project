...
export const CTX_INLINE_CHAT_HAS_AGENT = new RawContextKey<boolean>(
	...
	false,
	localize('inlineChatHasProvider', 'Whether a provider for interactive editors exists'),
)
...
export const CTX_INLINE_CHAT_VISIBLE = new RawContextKey<boolean>(
	'inlineChatVisible',
	false,
	localize('inlineChatVisible', 'Whether the interactive editor input is visible'),
)
export const CTX_INLINE_CHAT_FOCUSED = new RawContextKey<boolean>(
	'inlineChatFocused',
	false,
	localize('inlineChatFocused', 'Whether the interactive editor input is focused'),
)
...
export const CTX_INLINE_CHAT_RESPONSE_FOCUSED = new RawContextKey<boolean>(
	...
	false,
	localize('inlineChatResponseFocused', "Whether the interactive widget's response is focused"),
)
...
export const CTX_INLINE_CHAT_CHANGE_HAS_DIFF = new RawContextKey<boolean>(
	...
	false,
	localize('inlineChatChangeHasDiff', 'Whether the current change supports showing a diff'),
)
export const CTX_INLINE_CHAT_CHANGE_SHOWS_DIFF = new RawContextKey<boolean>(
	'inlineChatChangeShowsDiff',
	false,
	localize('inlineChatChangeShowsDiff', 'Whether the current change showing a diff'),
)
...
export const CTX_INLINE_CHAT_RESPONSE_TYPE = new RawContextKey<InlineChatResponseType>(
...
export const inlineChatForeground = registerColor(
	...
	editorWidgetForeground,
	localize('inlineChat.foreground', 'Foreground color of the interactive editor widget'),
)
export const inlineChatBackground = registerColor(
	'inlineChat.background',
	editorWidgetBackground,
	localize('inlineChat.background', 'Background color of the interactive editor widget'),
)
...
export const inlineChatInputBorder = registerColor(
	...
	editorWidgetBorder,
	localize('inlineChatInput.border', 'Border color of the interactive editor input'),
)
...
export const inlineChatInputBackground = registerColor(
	...
	inputBackground,
	localize('inlineChatInput.background', 'Background color of the interactive editor input'),
)
