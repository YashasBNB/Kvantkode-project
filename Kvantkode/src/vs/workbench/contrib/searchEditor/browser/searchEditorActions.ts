...
export const openNewSearchEditor = async (
	...
	const searchOnType =
		configurationService.getValue<ISearchConfigurationProperties>('search').searchOnType
...
export const createEditorFromSearchResult = async (
	...
	const configurationService = accessor.get(IConfigurationService)
	const sortOrder =
		configurationService.getValue<ISearchConfigurationProperties>('search').sortOrder
	...
	const contextLines =
		configurationService.getValue<ISearchConfigurationProperties>('search').searchEditor
