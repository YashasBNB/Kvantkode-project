...
registerColor(
	...
	nls.localize('commentReplyInputBackground', 'Background color for comment reply input box.'),
)
...
export const commentThreadRangeBackground = registerColor(
	...
	nls.localize('commentThreadRangeBackground', 'Color of background for comment ranges.'),
)
