...
export const CTX_NOTEBOOK_CHAT_HAS_ACTIVE_REQUEST = new RawContextKey<boolean>(
	...
	false,
	localize('notebookChatHasActiveRequest', 'Whether the cell chat editor has an active request'),
)
...
export const CTX_NOTEBOOK_CHAT_OUTER_FOCUS_POSITION = new RawContextKey<'above' | 'below' | ''>(
...
export const CTX_NOTEBOOK_CHAT_HAS_AGENT = new RawContextKey<boolean>(
	...
	false,
	localize('notebookChatAgentRegistered', 'Whether a chat agent for notebook is registered'),
)
