...
export const ctxMergeEditorLayout = new RawContextKey<MergeEditorLayoutKind>(
	'mergeEditorLayout',
	'mixed',
	{ type: 'string', description: localize('editorLayout', 'The layout mode of a merge editor') },
)
...
export const ctxMergeEditorShowBaseAtTop = new RawContextKey<boolean>(
	...
	false,
	{ type: 'boolean', description: localize('showBaseAtTop', 'If base should be shown at the top') },
)
