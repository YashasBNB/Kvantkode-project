...
registerTerminalAction({
	...
	run: (c, accessor) =>
		accessor.get(IPreferencesService).openSettings({ query: terminalSuggestConfigSection }),
})
...
registerActiveInstanceAction({
	...
	run: (activeInstance) =>
		TerminalSuggestContribution.get(activeInstance)?.addon?.requestCompletions(true),
})
...
registerActiveInstanceAction({
	...
	run: (activeInstance) =>
		TerminalSuggestContribution.get(activeInstance)?.addon?.selectPreviousSuggestion(),
})
...
registerActiveInstanceAction({
	...
	run: (activeInstance) =>
		TerminalSuggestContribution.get(activeInstance)?.addon?.selectPreviousPageSuggestion(),
})
...
registerActiveInstanceAction({
	...
	run: (activeInstance) =>
		TerminalSuggestContribution.get(activeInstance)?.addon?.selectNextSuggestion(),
})
...
registerActiveInstanceAction({
	...
	run: (activeInstance) =>
		TerminalSuggestContribution.get(activeInstance)?.addon?.toggleSuggestionFocus(),
})
...
registerActiveInstanceAction({
	...
	run: (activeInstance) =>
		TerminalSuggestContribution.get(activeInstance)?.addon?.toggleSuggestionDetails(),
})
...
registerActiveInstanceAction({
	...
	run: (activeInstance) =>
		TerminalSuggestContribution.get(activeInstance)?.addon?.selectNextPageSuggestion(),
})
...
registerActiveInstanceAction({
	...
	run: (activeInstance) =>
		TerminalSuggestContribution.get(activeInstance)?.addon?.acceptSelectedSuggestion(),
})
