...
export const QuickEditChat = ({
	...
	const loadingIcon = (
		<div className="@@codicon @@codicon-loading @@codicon-modifier-spin @@codicon-no-default-spin text-void-fg-3" />
	)
	...
	return (
		<div ref={sizerRef} style={{ maxWidth: 450 }} className={`py-2 w-full`}>
			<VoidChatArea
				featureName="Ctrl+K"
				divRef={chatAreaRef}
				onSubmit={onSubmit}
