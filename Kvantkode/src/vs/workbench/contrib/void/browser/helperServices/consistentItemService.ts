...
export const IConsistentItemService =
	createDecorator<IConsistentItemService>('ConsistentItemService')
...
export const IConsistentEditorItemService = createDecorator<IConsistentEditorItemService>(
