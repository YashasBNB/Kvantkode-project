...
export namespace ChatContextKeys {
	export const responseVote = new RawContextKey<string>('chatSessionResponseVote', '', {
		type: 'string',
	...
	export const responseHasError = new RawContextKey<boolean>('chatSessionResponseError', false, {
		type: 'boolean',
		description: localize(
			'chatResponseErrored',
	...
	export const isRequestPaused = new RawContextKey<boolean>('chatRequestIsPaused', false, {
		type: 'boolean',
		description: localize('chatRequestIsPaused', 'True when the current request is paused.'),
	})
	export const canRequestBePaused = new RawContextKey<boolean>('chatCanRequestBePaused', false, {
		type: 'boolean',
	...
	export const editApplied = new RawContextKey<boolean>('chatEditApplied', false, {
		type: 'boolean',
		description: localize('chatEditApplied', 'True when the chat text edits have been applied.'),
	})

	export const inputHasText = new RawContextKey<boolean>('chatInputHasText', false, {
		type: 'boolean',
		description: localize('interactiveInputHasText', 'True when the chat input has text.'),
	})
	export const inputHasFocus = new RawContextKey<boolean>('chatInputHasFocus', false, {
		type: 'boolean',
	...
	export const inUnifiedChat = new RawContextKey<boolean>('inUnifiedChat', false, {
		type: 'boolean',
		description: localize(
			'inUnifiedChat',
	...
	export const instructionsAttached = new RawContextKey<boolean>(
	...
	export const chatMode = new RawContextKey<ChatMode>('chatMode', ChatMode.Ask, {
		type: 'string',
	...
	) // supported on desktop and in web only with a remote connection
	...
	export const chatEditingCanUndo = new RawContextKey<boolean>('chatEditingCanUndo', false, {
		type: 'boolean',
		description: localize(
			'chatEditingCanUndo',
	...
	export const chatEditingCanRedo = new RawContextKey<boolean>('chatEditingCanRedo', false, {
		type: 'boolean',
		description: localize(
			'chatEditingCanRedo',
	...
	export const extensionInvalid = new RawContextKey<boolean>('chatExtensionInvalid', false, {
		type: 'boolean',
		description: localize(
	...
	export const inQuickChat = new RawContextKey<boolean>('quickChatHasFocus', false, {
		type: 'boolean',
		description: localize('inQuickChat', 'True when the quick chat UI has focus, false otherwise.'),
	})
	export const hasFileAttachments = new RawContextKey<boolean>('chatHasFileAttachments', false, {
		type: 'boolean',
	...
	export const SetupViewCondition = ContextKeyExpr.and(
		...
		ContextKeyExpr.or(
			...
			ContextKeyExpr.and(ChatContextKeys.Entitlement.canSignUp, ChatContextKeys.Setup.installed),
			ContextKeyExpr.and(ChatContextKeys.Entitlement.signedOut, ChatContextKeys.Setup.installed),
		),
	)!
	...
	export const Editing = {
		hasToolsAgent: new RawContextKey<boolean>('chatHasToolsAgent', false, {
			type: 'boolean',
			description: localize('chatEditingHasToolsAgent', 'True when a tools agent is registered.'),
		}),
		agentModeDisallowed: new RawContextKey<boolean>('chatAgentModeDisallowed', undefined, {
			type: 'boolean',
			description: localize('chatAgentModeDisallowed', 'True when agent mode is not allowed.'),
		}), // experiment-driven disablement
		hasToolConfirmation: new RawContextKey<boolean>('chatHasToolConfirmation', false, {
			type: 'boolean',
			description: localize(
...
export namespace ChatContextKeyExprs {
	export const unifiedChatEnabled = ContextKeyExpr.has(
