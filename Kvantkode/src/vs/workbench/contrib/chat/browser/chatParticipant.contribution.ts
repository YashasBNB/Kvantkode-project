		...
		chatParticipantExtensionPoint.setHandler((extensions, delta) => {
			for (const extension of delta.added) {
				for (const providerDescriptor of extension.value) {
					...
					if (
						(providerDescriptor.isDefault || providerDescriptor.isAgent) &&
						...
						store.add(
							this._chatAgentService.registerAgent(providerDescriptor.id, {
								...
								publisherDisplayName:
									extension.description.publisherDisplayName ?? extension.description.publisher, // May not be present in OSS
