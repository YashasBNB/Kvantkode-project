...
class AuthenticationContribution extends Disposable implements IWorkbenchContribution {
	...
	private _placeholderMenuItem: IDisposable | undefined = MenuRegistry.appendMenuItem(
	...
	private _registerHandlers(): void {
		this._register(
			this._authenticationService.onDidRegisterAuthenticationProvider((_e) => {
				this._clearPlaceholderMenuItem()
			}),
		)
		this._register(
			this._authenticationService.onDidUnregisterAuthenticationProvider((_e) => {
