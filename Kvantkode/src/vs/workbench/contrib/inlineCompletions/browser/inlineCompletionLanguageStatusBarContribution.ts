	...
	constructor(
		...
		this._register(
			autorunWithStore((reader, store) => {
				...
				InlineCompletionLanguageStatusBarContribution.languageStatusBarDisposables.forEach((d) =>
					d.clear(),
				)
				...
				store.add({
					dispose: () =>
						InlineCompletionLanguageStatusBarContribution.languageStatusBarDisposables.delete(
							store,
						),
				})
