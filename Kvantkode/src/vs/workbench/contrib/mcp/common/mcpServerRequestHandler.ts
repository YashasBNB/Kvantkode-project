...
export class McpServerRequestHandler extends Disposable {
	...
	listPrompts(
		...
		return this.sendRequestPaginated<MCP.ListPromptsRequest, MCP.ListPromptsResult, MCP.Prompt>(
			'prompts/list',
	...
	listTools(
		...
		return this.sendRequestPaginated<MCP.ListToolsRequest, MCP.ListToolsResult, MCP.Tool>(
			'tools/list',
			(result) => result.tools,
			params,
			token,
	 ...
	 */
	callTool(
		params: MCP.CallToolRequest['params'],
		token?: CancellationToken,
