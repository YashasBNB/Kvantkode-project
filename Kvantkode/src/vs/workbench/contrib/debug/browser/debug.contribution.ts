...
if (isWeb) {
	Registry.as<IWorkbenchContributionsRegistry>(
		WorkbenchExtensions.Workbench,
	).registerWorkbenchContribution(DebugTitleContribution, LifecyclePhase.Eventually)
}
Registry.as<IWorkbenchContributionsRegistry>(
	WorkbenchExtensions.Workbench,
...
Registry.as<IWorkbenchContributionsRegistry>(
	WorkbenchExtensions.Workbench,
).registerWorkbenchContribution(DebugContentProvider, LifecyclePhase.Eventually)
Registry.as<IWorkbenchContributionsRegistry>(
	WorkbenchExtensions.Workbench,
).registerWorkbenchContribution(StatusBarColorProvider, LifecyclePhase.Eventually)
Registry.as<IWorkbenchContributionsRegistry>(
	WorkbenchExtensions.Workbench,
).registerWorkbenchContribution(DisassemblyViewContribution, LifecyclePhase.Eventually)
Registry.as<IWorkbenchContributionsRegistry>(
	WorkbenchExtensions.Workbench,
