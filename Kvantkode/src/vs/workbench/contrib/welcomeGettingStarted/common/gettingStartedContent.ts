...
const setupIcon = registerIcon(
	...
	Codicon.zap,
	localize('getting-started-setup-icon', 'Icon used for the setup category of welcome page'),
)
const beginnerIcon = registerIcon(
	'getting-started-beginner',
	Codicon.lightbulb,
	localize('getting-started-beginner-icon', 'Icon used for the beginner category of welcome page'),
)
			...
			steps: [
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('openFolder', 'Open Folder'), 'command:workbench.action.addRootFolder'),
						Button(
			...
			steps: [
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('openGoToSymbol', 'Go to Symbol'), 'command:editor.action.goToSymbol'),
					),
					media: {
						type: 'markdown',
						path: 'empty',
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('toggleFold', 'Toggle Fold'), 'command:editor.toggleFold'),
						Button(
				...
				},
				{
					...
					description: localize(
						...
						Button(
							localize('openAccessibilitySettings', 'Open Accessibility Settings'),
							'command:workbench.action.openAccessibilitySettings',
						),
					),
					media: { type: 'markdown', path: 'empty' },
			...
			steps: [
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('cloneRepo', 'Clone Repository'), 'command:git.clone'),
					),
				...
				},
				{
					...
					description: localize(
						...
						'Set up the built-in version control for your project to track your changes and collaborate with others.\n{0}',
						Button(localize('initRepo', 'Initialize Git Repository'), 'command:git.init'),
					),
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('openSCM', 'Open Source Control'), 'command:workbench.view.scm'),
					),
				...
				},
				{
					...
					description: localize(
						...
						Button(localize('installGit', 'Install Git'), 'https://aka.ms/vscode-install-git'),
						'[',
