...
suite('Workbench - TerminalConfigurationService', () => {
	...
	suite('getFont', () => {
		test('fontFamily', () => {
			...
			ok(
				terminalConfigurationService.getFont(getActiveWindow()).fontFamily.startsWith('bar'),
		...
		test('fontFamily (Linux Unknown)', () => {
			...
			ok(
				terminalConfigurationService.getFont(getActiveWindow()).fontFamily.startsWith('foo'),
