...
export class RemoteTerminalChannelClient implements IPtyHostController {
	...
	get onDidChangeProperty(): Event<{ id: number; property: IProcessProperty<any> }> {
		return this._channel.listen<{ id: number; property: IProcessProperty<any> }>(
	...
	requestDetachInstance(
		...
		return this._channel.call(RemoteTerminalChannelRequest.RequestDetachInstance, [
			workspaceId,
			instanceId,
		])
	}
	acceptDetachInstanceReply(requestId: number, persistentProcessId: number): Promise<void> {
		return this._channel.call(RemoteTerminalChannelRequest.AcceptDetachInstanceReply, [
			requestId,
			persistentProcessId,
		])
	}
	...
	acceptPtyHostResolvedVariables(requestId: number, resolved: string[]): Promise<void> {
		return this._channel.call(RemoteTerminalChannelRequest.AcceptPtyHostResolvedVariables, [
			requestId,
			resolved,
		])
	}
	...
	reviveTerminalProcesses(
		...
		return this._channel.call(RemoteTerminalChannelRequest.ReviveTerminalProcesses, [
			workspaceId,
			state,
