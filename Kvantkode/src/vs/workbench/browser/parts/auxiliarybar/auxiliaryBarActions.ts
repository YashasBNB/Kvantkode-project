...
const auxiliaryBarLeftIcon = registerIcon(
	...
	localize('toggleAuxiliaryIconLeft', 'Icon to toggle the auxiliary bar in its left position.'),
)
...
export class ToggleAuxiliaryBarAction extends Action2 {
	...
	static readonly LABEL = localize2('toggleAuxiliaryBar', 'Toggle KvantKode Side Bar Visibility')
		...
		super({
			...
			metadata: {
				description: localize(
					...
					'Open/Show and Close/Hide KvantKode Side Bar',
				),
			},
			f1: true,
			keybinding: {
...
registerAction2(
	class FocusAuxiliaryBarAction extends Action2 {
		...
		static readonly LABEL = localize2('focusAuxiliaryBar', 'Focus into KvantKode Side Bar')
