...
export class WorkbenchContextKeysHandler extends Disposable {
	...
	private registerListeners(): void {
		...
		this._register(
			this.paneCompositeService.onDidPaneCompositeClose(() => this.updateSideBarContextKeys()),
		)
		this._register(
			this.paneCompositeService.onDidPaneCompositeOpen(() => this.updateSideBarContextKeys()),
		)
