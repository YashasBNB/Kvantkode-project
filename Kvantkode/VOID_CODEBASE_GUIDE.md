...
The purpose of this document is to explain how Void's codebase works. If you want build instructions instead, see [Contributing](https://github.com/YashasBNB/Kvantkode-project/blob/main/HOW_TO_CONTRIBUTE.md).
...
If you want to know how our build pipeline works, see our build repo [here](https://github.com/YashasBNB/Kvantkode-project).
