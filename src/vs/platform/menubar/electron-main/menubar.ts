	...
	private install(): void {
		...
		if (this.shouldDrawMenu('File')) {
			...
			const fileMenuItem = new MenuItem({
				label: this.mnemonicLabel(
					nls.localize({ key: 'mFile', comment: ['&& denotes a mnemonic'] }, '&&File'),
				),
				submenu: fileMenu,
			})
		...
		if (this.shouldDrawMenu('Edit')) {
			...
			const editMenuItem = new MenuItem({
				label: this.mnemonicLabel(
					nls.localize({ key: 'mEdit', comment: ['&& denotes a mnemonic'] }, '&&Edit'),
				),
				submenu: editMenu,
			})
		...
		if (this.shouldDrawMenu('View')) {
			...
			const viewMenuItem = new MenuItem({
				label: this.mnemonicLabel(
					nls.localize({ key: 'mView', comment: ['&& denotes a mnemonic'] }, '&&View'),
				),
				submenu: viewMenu,
			})
		...
		if (this.shouldDrawMenu('Go')) {
			...
			const gotoMenuItem = new MenuItem({
				label: this.mnemonicLabel(
					nls.localize({ key: 'mGoto', comment: ['&& denotes a mnemonic'] }, '&&Go'),
				),
				submenu: gotoMenu,
			})
		...
		if (this.shouldDrawMenu('Run')) {
			...
			const debugMenuItem = new MenuItem({
				label: this.mnemonicLabel(
					nls.localize({ key: 'mRun', comment: ['&& denotes a mnemonic'] }, '&&Run'),
				),
				submenu: debugMenu,
			})
		...
		if (this.shouldDrawMenu('Terminal')) {
			...
			const terminalMenuItem = new MenuItem({
				label: this.mnemonicLabel(
					nls.localize({ key: 'mTerminal', comment: ['&& denotes a mnemonic'] }, '&&Terminal'),
				),
		...
		if (this.shouldDrawMenu('Help')) {
			...
			const helpMenuItem = new MenuItem({
				label: this.mnemonicLabel(
					nls.localize({ key: 'mHelp', comment: ['&& denotes a mnemonic'] }, '&&Help'),
				),
				submenu: helpMenu,
				role: 'help',
			})
	...
	private setMacWindowMenu(macWindowMenu: Menu): void {
		...
		if (this.currentEnableNativeTabs) {
			...
			nativeTabMenuItems.push(
				this.createMenuItem(nls.localize('mNewTab', 'New Tab'), 'workbench.action.newWindowTab'),
			)
