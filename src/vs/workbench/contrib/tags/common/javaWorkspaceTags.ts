...
export const JavaLibrariesToLookFor: {
	...
	{
		predicate: (groupId, artifactId) =>
			groupId.startsWith('com.microsoft.azure') && artifactId.startsWith('azure-mgmt-'),
		tag: 'azure',
	},
	{
		predicate: (groupId, artifactId) =>
			groupId === 'com.azure.resourcemanager' && artifactId.startsWith('azure-resourcemanager'),
		tag: 'azure',
	}, // azure track2 sdk
	// java ee
	{
	...
	{
		predicate: (groupId, artifactId) =>
			groupId === 'com.azure' && artifactId.startsWith('azure-messaging-eventhubs'),
		tag: 'azure-eventhubs',
	},
	{
		predicate: (groupId, artifactId) =>
	...
	{
		predicate: (groupId, artifactId) =>
			groupId === 'com.microsoft.azure.functions' && artifactId === 'azure-functions-java-library',
		tag: 'azure-functions',
	},
	// quarkus
