 ...
 */
export const askToSelectPrompt = async (options: ISelectPromptOptions): Promise<void> => {
	...
	return await new Promise<void>((resolve) => {
		...
		disposables.add(
			quickPick.onDidTriggerItemButton(handleButtonClick.bind(null, { quickPick, ...options })),
		)
