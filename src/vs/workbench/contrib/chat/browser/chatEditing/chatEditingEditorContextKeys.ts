...
export const ctxIsGlobalEditingSession = new RawContextKey<boolean>(
	...
	undefined,
	localize('chat.ctxEditSessionIsGlobal', 'The current editor is part of the global edit session'),
)
export const ctxHasEditorModification = new RawContextKey<boolean>(
	'chatEdits.hasEditorModifications',
	undefined,
	localize('chat.hasEditorModifications', 'The current editor contains chat modifications'),
)
export const ctxReviewModeEnabled = new RawContextKey<boolean>(
	'chatEdits.isReviewModeEnabled',
	true,
	localize('chat.ctxReviewModeEnabled', 'Review mode for chat changes is enabled'),
)
...
export const ctxRequestCount = new RawContextKey<number>(
	...
	0,
	localize('chatEdits.requestCount', 'The number of turns the editing session in this editor has'),
)
...
export class ObservableEditorSession {
	readonly value: IObservable<
		| undefined
		| { session: IChatEditingSession; entry: IModifiedFileEntry | undefined; isInlineChat: boolean }
	>
	...
	constructor(
		...
		const inlineSessionObs = observableFromEvent(this, inlineChatService.onDidChangeSessions, () =>
