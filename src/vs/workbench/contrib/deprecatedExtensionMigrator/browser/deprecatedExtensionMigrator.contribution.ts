		...
		this.notificationService.notify({
			...
			actions: {
				primary: [
					new Action(
						'',
						localize('bracketPairColorizer.notification.action.uninstall', 'Uninstall Extension'),
						undefined,
						undefined,
						() => {
				...
				secondary: [
					...
					new Action(
						'',
						localize('bracketPairColorizer.notification.action.showMoreInfo', 'More Info'),
						undefined,
						undefined,
						() => {
...
).registerWorkbenchContribution(DeprecatedExtensionMigratorContribution, LifecyclePhase.Restored)
