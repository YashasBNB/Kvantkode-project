...
class EditSettingRenderer extends Disposable {
	...
	private readonly _onUpdateSetting: Emitter<{ key: string; value: any; source: IIndexedSetting }> =
		this._register(new Emitter<{ key: string; value: any; source: IIndexedSetting }>())
	readonly onUpdateSetting: Event<{ key: string; value: any; source: IIndexedSetting }> =
