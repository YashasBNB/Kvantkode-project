	...
	constructor(
		...
		this._register(
			this._editorService.onDidActiveEditorChange(() => {
				...
				const instance =
					activeEditor instanceof TerminalEditorInput ? activeEditor?.terminalInstance : undefined
		...
		this._register(
			this._editorService.onDidVisibleEditorsChange(() => {
				...
				const unknownEditor = terminalEditors.find((input) => {
					const inputId =
						input instanceof TerminalEditorInput ? input.terminalInstance?.instanceId : undefined
		...
		this._register(
			this._editorService.onDidCloseEditor((e) => {
				const instance =
					e.editor instanceof TerminalEditorInput ? e.editor.terminalInstance : undefined
				if (instance) {
