...
class TrustedUriPathColumnRenderer
	implements ITableRenderer<ITrustedUriItem, ITrustedUriPathColumnTemplateData>
{
...
class TrustedUriHostColumnRenderer
	implements ITableRenderer<ITrustedUriItem, ITrustedUriHostColumnTemplateData>
{
...
export class WorkspaceTrustEditor extends EditorPane {
	...
	private registerListeners(): void {
		...
		this._register(
			this.workspaceTrustManagementService.onDidChangeTrustedFolders(() => this.render()),
		)
	}
