...
const _ctxHasCallHierarchyProvider = new RawContextKey<boolean>(
	...
	false,
	localize('editorHasCallHierarchyProvider', 'Whether a call hierarchy provider is available'),
)
const _ctxCallHierarchyVisible = new RawContextKey<boolean>(
	'callHierarchyVisible',
	false,
	localize('callHierarchyVisible', 'Whether call hierarchy peek is currently showing'),
)
		...
		constructor() {
			super({
				...
				icon: registerIcon(
					...
					localize('showIncomingCallsIcons', 'Icon for incoming calls in the call hierarchy view.'),
				),
		...
		constructor() {
			super({
				...
				icon: registerIcon(
					...
					localize('showOutgoingCallsIcon', 'Icon for outgoing calls in the call hierarchy view.'),
				),
				precondition: ContextKeyExpr.and(
					_ctxCallHierarchyVisible,
