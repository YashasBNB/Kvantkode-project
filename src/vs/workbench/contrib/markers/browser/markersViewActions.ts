...
export class MarkersFilters extends Disposable {
	...
	private readonly _excludedFiles = MarkersContextKeys.ShowExcludedFilesFilterContextKey.bindTo(
	...
	private readonly _activeFile = MarkersContextKeys.ShowActiveFileFilterContextKey.bindTo(
		this.contextKeyService,
	)
	...
	private readonly _showWarnings = MarkersContextKeys.ShowWarningsFilterContextKey.bindTo(
		this.contextKeyService,
	)
	...
	private readonly _showErrors = MarkersContextKeys.ShowErrorsFilterContextKey.bindTo(
		this.contextKeyService,
	)
	...
	private readonly _showInfos = MarkersContextKeys.ShowInfoFilterContextKey.bindTo(
		this.contextKeyService,
	)
