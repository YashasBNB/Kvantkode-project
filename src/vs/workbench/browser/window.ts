...
export class BrowserWindow extends BaseWindow {
	...
	private registerListeners(): void {
		...
		this._register(
			addDisposableListener(this.layoutService.mainContainer, EventType.CONTEXT_MENU, (e) =>
		...
		this._register(
			addDisposableListener(this.layoutService.mainContainer, EventType.DROP, (e) =>
				EventHelper.stop(e, true),
			),
		)
	}
