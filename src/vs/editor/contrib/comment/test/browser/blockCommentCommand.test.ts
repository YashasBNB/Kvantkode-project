...
function testBlockCommentCommand(
	...
	_testCommentCommand(
		...
		selection,
		(accessor, sel) =>
			new BlockCommentCommand(sel, true, accessor.get(ILanguageConfigurationService)),
		expectedLines,
		expectedSelection,
	)
}
	...
	test('insertSpace false', () => {
		function testLineCommentCommand(
			...
			_testCommentCommand(
				...
				selection,
				(accessor, sel) =>
					new BlockCommentCommand(sel, false, accessor.get(ILanguageConfigurationService)),
				expectedLines,
				expectedSelection,
			)
		}
