...
export class TokenizationTextModelPart extends TextModelPart implements ITokenizationTextModelPart {
	...
	private readonly _onDidChangeLanguage: Emitter<IModelLanguageChangedEvent> = this._register(
	...
	private readonly _onDidChangeTokens: Emitter<IModelTokensChangedEvent> = this._register(
