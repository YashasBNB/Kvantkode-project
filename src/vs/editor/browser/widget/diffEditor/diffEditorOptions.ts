...
export class DiffEditorOptions {
	...
	public readonly showMoves = derived(
		this,
		(reader) =>
			this._options.read(reader).experimental.showMoves! && this.renderSideBySide.read(reader),
	)
	...
	private readonly trueInlineDiffRenderingEnabled: IObservable<boolean> = derived(
		this,
