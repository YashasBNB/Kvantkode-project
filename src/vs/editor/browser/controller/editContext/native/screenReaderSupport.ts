...
export class ScreenReaderSupport {
	...
	private _updateDomAttributes(): void {
		...
		const wordWrapValue =
			wordWrapOverride2 !== 'inherit' ? wordWrapOverride2 : options.get(EditorOption.wordWrap)
	...
	public render(ctx: RestrictedRenderingContext): void {
		...
		const offsetForStartPositionWithinEditor =
		...
		const offsetForPositionLineNumber =
			this._context.viewLayout.getVerticalOffsetForLineNumber(positionLineNumber)
